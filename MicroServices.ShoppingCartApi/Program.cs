...
using AutoMapper;
using MicroServices.ShoppingCartApi;
...
builder.Services.AddHttpClient("Product",
    u => u.BaseAddress = new Uri(builder.Configuration.GetSection("ServiceUrls:ProductApi").Value));
builder.Services.AddScoped<IProductService,ProductService>();
builder.Services.AddHttpClient("Coupon",
    u => u.BaseAddress = new Uri(builder.Configuration.GetSection("ServiceUrls:CouponApi").Value));
